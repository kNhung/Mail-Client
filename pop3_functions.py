...
def receive_mail(POP3_HOST, POP3_PORT, BUFFER_SIZE, DOMAIN, pop3_socket, username, password):
    ...
    if (pop3_valid_reponse(pop3_socket.recv(BUFFER_SIZE).decode()) == 0) : 
    ...
    message = pop3_socket.recv(BUFFER_SIZE).decode()
