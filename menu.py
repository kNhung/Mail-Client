...
def menu():
    ...
    receive_option = FunctionItem("Manually Load Mail", pop3_functions.receive_mail)
    show_mail_option = FunctionItem("Show Mail", show_mail.autoload_show)
    test_option = FunctionItem("Show current username", show_current_user)
